<template>
  <section section class="ContentHeight">
    ...
    <!-- message text -->
    <div v-if="DspConfirmCode" class="container px-5 pt-5">
      {{ DspConfirmCode.Message }}
    </div>
...
export default {
  ...
  computed: {
    ...mapGetters(["DspConfirmCode", "DspRegisterInfo"]),
  },
  methods: {
    ...mapActions(["RegisterUser"]),
    /* register user */
    Register() {
      if (this.DspConfirmCode.Data !== null) {
        this.RegisterUser({
          mobile: this.DspConfirmCode.Data.Mobile,
          code: this.ConfirmCode,
        });
        /* if register was ok navigate to home */
        this.$router.push("/login/completeregister");
      }
    },
  },
};
