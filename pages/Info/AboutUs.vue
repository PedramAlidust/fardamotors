<template>
  <section class="ContentHeight">
    <!-- Notificationa -->
     <div class="container-full">
      <div class="bg-dark py-3">
        ...
        <p class="text-white text-center">درباره ما</p>
    ...
    <div style="min-height: 100vh" class="px-4">
      ...
      <div class="container shadow-sm ReqStatus mt-5 py-3 ps-3">
        <div class="ReqStatus text-center Contracts">
                <p>گروه خودرو سازي فردا </p>
        </div>
      </div>
      <div class="text-center mt-5">
        <img class="AboutLogo" src="~/assets/pictures/FardaLogoPages.png" alt="AboutLogo">
      </div>
    </div>
  </section>
</template>
